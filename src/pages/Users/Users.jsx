...
export default function UsersPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto bg-white text-black p-6 sm:p-8 rounded-2xl ">
        {/* Title */}
        <h1 className="text-2xl sm:text-3xl font-bold text-center mb-6">Manage Users</h1>
        ...
        <div className="space-y-4">
          {users.map((user) => (
            <div
              key={user.id}
              className="flex flex-col sm:grid sm:grid-cols-3 items-center bg-gray-100 p-4 rounded-md "
            >
              {/* Name */}
              ...
              {/* Email */}
              <div className="text-center sm:text-left mb-2 sm:mb-0 break-words">{user.email}</div>
